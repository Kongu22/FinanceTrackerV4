...
import { FaEdit, FaTrash, FaCheck, FaArrowUp, FaArrowDown, FaSyncAlt } from 'react-icons/fa';
import {
  Table,
  TableBody,
  TableCell,
  ...
  Checkbox,
  useTheme,
  // Remove the unused Typography import
} from '@mui/material';
            ...
            >
              {editingId === transaction.id ? (
                      ...
                      <Grid container spacing={2}>
                          ...
                          <Select
                            ...
                            renderValue={(selected) => (
                              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <Box sx={{ ml: 1 }}>{currentTranslations[selected.toLowerCase()]}</Box>
                              </Box>
                            )}
                          >
                        ...
                        <Grid item xs={12}>
                          <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                            ...
                            <ModernButton onClick={() => setEditingId(null)}>
                ...
                <>
                  ...
                  <TableCell>
                    <StyledIconWrapper>{categoryIcons[transaction.category] || <MoreHorizIcon />}</StyledIconWrapper>{' '}
                    {/* Display icon based on category */}
                    {currentTranslations.categories[transaction.category]}
                  </TableCell>
                  <TableCell
                    sx={{
                      fontWeight: 'bold',
